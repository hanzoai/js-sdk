...
export const LinksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getV1LinksUsage: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getV1LinksUsageSummary: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        postV1Links: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/links`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        postV1LinksUsage: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/links/usage`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const LinksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteV1LinksById(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1Links(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1LinksById(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1LinksDevicesByMachine(machine: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1LinksRoute(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1LinksUsage(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getV1LinksUsage(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getV1LinksUsageAccounts(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getV1LinksUsageSummary(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getV1LinksUsageSummary(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async postV1Links(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postV1Links(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async postV1LinksDevicesByMachineRevoke(machine: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async postV1LinksUsage(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postV1LinksUsage(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const LinksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteV1LinksById(requestParameters: LinksApiDeleteV1LinksByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1Links(options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1LinksById(requestParameters: LinksApiGetV1LinksByIdRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1LinksDevicesByMachine(requestParameters: LinksApiGetV1LinksDevicesByMachineRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1LinksRoute(options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1LinksUsage(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getV1LinksUsage(options).then((request) => request(axios, basePath));
        },
        /**
         * Answers one row per linked account the GATEWAY actually routed through, plus their total — requests, prompt and completion tokens, and cost. This is the routed ledger, the read twin of the counter the router writes, and it is distinct from both of its neighbours: not the device collector\'s plan snapshots, and not the org money ledger. The `source` and `scope` fields on the response say so on every payload.  The same shape answers in the billing namespace, from one shaping function, so the two mounts cannot drift. Scoped to the caller: a validated principal and a non-empty org, else 403. Both org and subject are bound predicates on every statement, so a caller reads and writes only their OWN accounts within their own org — the org is never a parameter, and there is no path to another user\'s links.
         * @summary Break down what the gateway routed through each of your accounts
         ...
         * @throws {RequiredError}
         */
        getV1LinksUsageAccounts(options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getV1LinksUsageSummary(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getV1LinksUsageSummary(options).then((request) => request(axios, basePath));
        },
        /**
         * Records that a developer has signed into one provider account on one machine — a Claude Max or ChatGPT Plus subscription, a Hanzo key, a raw provider key — and answers with the stored link. Re-reporting the same (machine, provider, account) UPDATES that link rather than creating a second, so a collector may call this on every heartbeat.  NO SECRET IS SENT OR STORED. The provider\'s OAuth token or API key stays on the device; this registry holds link metadata and usage snapshots only, and the caller authenticates with their own Hanzo bearer. `kind` decides how the account\'s inference BILLS and defaults to `subscription`: a subscription account bills the user\'s own monthly plan and is metered here for visibility only, while an `apikey` account bills through commerce on the gateway path. An optional `usage` snapshot is clamped and re-serialized to known fields; omitting it keeps the last good one.  `machine` and `provider` are required (400 otherwise), as is a valid kind, and every field is length-bounded. Scoped to the caller: a validated principal and a non-empty org, else 403. Both org and subject are bound predicates on every statement, so a caller reads and writes only their OWN accounts within their own org — the org is never a parameter, and there is no path to another user\'s links.
         * @summary Register a signed-in AI provider account on a machine
         ...
         * @throws {RequiredError}
         */
        postV1Links(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.postV1Links(options).then((request) => request(axios, basePath));
        },
        /**
         * Revokes every one of the caller\'s accounts on one machine and stops the agent sessions they were running, answering with how many of each. This is the \"I lost that laptop\" button.  Revoked links are RETAINED, not deleted, so usage history and the audit trail survive a log-out — the rows come back in the response with their new status. The session stop reaches only the REVOKING user\'s own sessions, so a shared machine name can never be used to stop a co-tenant\'s work, and a stop that fails does not fail the revoke: the revoked row is the durable truth and the count then honestly reports fewer. A machine with nothing left to revoke is 404. Scoped to the caller: a validated principal and a non-empty org, else 403. Both org and subject are bound predicates on every statement, so a caller reads and writes only their OWN accounts within their own org — the org is never a parameter, and there is no path to another user\'s links.
         * @summary Log out every account on one machine and stop its sessions
         ...
         * @throws {RequiredError}
         */
        postV1LinksDevicesByMachineRevoke(requestParameters: LinksApiPostV1LinksDevicesByMachineRevokeRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        postV1LinksUsage(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.postV1LinksUsage(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class LinksApi extends BaseAPI {
     ...
     * @memberof LinksApi
     */
    public getV1LinksUsage(options?: RawAxiosRequestConfig) {
        return LinksApiFp(this.configuration).getV1LinksUsage(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LinksApi
     */
    public getV1LinksUsageSummary(options?: RawAxiosRequestConfig) {
        return LinksApiFp(this.configuration).getV1LinksUsageSummary(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LinksApi
     */
    public postV1Links(options?: RawAxiosRequestConfig) {
        return LinksApiFp(this.configuration).postV1Links(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LinksApi
     */
    public postV1LinksUsage(options?: RawAxiosRequestConfig) {
        return LinksApiFp(this.configuration).postV1LinksUsage(options).then((request) => request(this.axios, this.basePath));
    }
}
