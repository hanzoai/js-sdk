...
export const TasksApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async optionsTasks(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TasksApi.optionsTasks']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Published because this address accepts every method, but the engine routes nothing here: the request arrives as an unrouted path and no workflow is read or started.
        ...
        async optionsTasksByWildcard1(wildcard1: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['TasksApi.optionsTasksByWildcard1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Published because this address accepts every method, but the engine routes nothing here: the request arrives as an unrouted path and no workflow is read or started.
...
export const TasksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Published because this address accepts every method, but the engine routes nothing here: the request arrives as an unrouted path and no workflow is read or started.
         * @summary Not routed by the durable engine
         * @param {TasksApiOptionsTasksByWildcard1Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        optionsTasksByWildcard1(requestParameters: TasksApiOptionsTasksByWildcard1Request, options?: RawAxiosRequestConfig): AxiosPromise<void> {
...
/**
 * Request parameters for optionsTasksByWildcard1 operation in TasksApi.
 * @export
 * @interface TasksApiOptionsTasksByWildcard1Request
 */
export interface TasksApiOptionsTasksByWildcard1Request {
    /**
     * 
     * @type {string}
     * @memberof TasksApiOptionsTasksByWildcard1
     */
    readonly wildcard1: string
}
...
export class TasksApi extends BaseAPI {
    ...
    public optionsTasks(options?: RawAxiosRequestConfig) {
        return TasksApiFp(this.configuration).optionsTasks(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public optionsTasksByWildcard1(requestParameters: TasksApiOptionsTasksByWildcard1Request, options?: RawAxiosRequestConfig) {
        return TasksApiFp(this.configuration).optionsTasksByWildcard1(requestParameters.wildcard1, options).then((request) => request(this.axios, this.basePath));
    }
