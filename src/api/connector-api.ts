...
export const ConnectorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        postV1ConnectorGithubWebhook: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ConnectorApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async postV1ConnectorGithubWebhook(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postV1ConnectorGithubWebhook(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ConnectorApi.postV1ConnectorGithubWebhook']?.[localVarOperationServerIndex]?.url;
...
export const ConnectorApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        postV1ConnectorGithubWebhook(options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.postV1ConnectorGithubWebhook(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ConnectorApi extends BaseAPI {
     ...
     */
    public postV1ConnectorGithubWebhook(options?: RawAxiosRequestConfig) {
        return ConnectorApiFp(this.configuration).postV1ConnectorGithubWebhook(options).then((request) => request(this.axios, this.basePath));
    }
}
